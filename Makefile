...
.PHONY: backend-test frontend-check check compose-config infra-lint infra-guard root-lint network-validate security-validate database-validate container-foundation-validate container-application-validate infra-validate up down logs ps clean
